			...
			<a class="tainacan-grid-item" href="<?php the_permalink(); ?>">
				...
				<?php else : ?>
					<div 
							...
							class="grid-item-thumbnail">
						<?php echo '<img alt="', esc_attr_e('Thumbnail placeholder', 'taina'), '" src="', esc_url(get_template_directory_uri()), '/assets/images/thumbnail_placeholder.png">'?>
						<div class="skeleton"></div> 
					</div>
				<?php endif; ?>  
			</a>	
	...
	<div class="tainacan-grid-container">
		<section class="section">
			<div class="content has-text-gray4 has-text-centered">
				...
				<p><?php echo __( 'No item was found.','taina' ); ?></p>
			</div>
		</section>
	</div>
<?php endif; ?>
