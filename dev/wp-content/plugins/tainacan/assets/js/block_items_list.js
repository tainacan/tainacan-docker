...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/views/gutenberg-blocks/tainacan-items/items-list/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/views/gutenberg-blocks/tainacan-items/items-list/index.js":
/*!***********************************************************************!*\
  !*** ./src/views/gutenberg-blocks/tainacan-items/items-list/index.js ***!
  \***********************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _items_modal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./items-modal.js */ "./src/views/gutenberg-blocks/tainacan-items/items-list/items-modal.js");
...
registerBlockType('tainacan/items-list', {
  ...
  icon: React.createElement("svg", {
    ...
    fill: "#298596",
    d: "M8.8,1.2H1.2V10H0V1.2C0,0.6,0.6,0,1.2,0h7.5V1.2z M3.8,2.5c-0.7,0-1.2,0.6-1.2,1.3v8.8c0,0.7,0.6,1.2,1.2,1.2h6.9 c0.7,0,1.2-0.6,1.2-1.2V6.3L8.1,2.5H3.8z M7.5,3.4L11,6.9H7.5V3.4z"
  })),
  ...
  edit: function edit(_ref) {
    ...
    var selectedItemsObject = attributes.selectedItemsObject,
        selectedItemsHTML = attributes.selectedItemsHTML,
    ...
    function prepareItem(item) {
      return React.createElement("li", {
        ...
        src: item.thumbnail && item.thumbnail[0] && item.thumbnail[0].src ? item.thumbnail[0].src : "".concat(tainacan_blocks.base_url, "/assets/images/placeholder_square.png"),
    ...
    function setContent() {
      ...
      for (var i = 0; i < selectedItemsObject.length; i++) {
    ...
    function removeItemOfId(itemId) {
      var existingItemIndex = selectedItemsObject.findIndex(function (existingItem) {
        return existingItem.id == 'item-id-' + itemId || existingItem.id == itemId;
      });
      if (existingItemIndex >= 0) selectedItemsObject.splice(existingItemIndex, 1);
      setContent();
    }
    ...
    return React.createElement("div", {
      ...
      min: 0,
      max: 48
    }))) : null))), isSelected ? React.createElement("div", null, isModalOpen ? React.createElement(_items_modal_js__WEBPACK_IMPORTED_MODULE_0__["default"], {
      ...
      onApplySelection: function onApplySelection(aSelectedItemsObject) {
    ...
    }) : null, selectedItemsHTML.length ? React.createElement("div", {
      ...
      d: "M8.8,1.2H1.2V10H0V1.2C0,0.6,0.6,0,1.2,0h7.5V1.2z M3.8,2.5c-0.7,0-1.2,0.6-1.2,1.3v8.8c0,0.7,0.6,1.2,1.2,1.2h6.9 c0.7,0,1.2-0.6,1.2-1.2V6.3L8.1,2.5H3.8z M7.5,3.4L11,6.9H7.5V3.4z"
    })), __('Expose items from your Tainacan collections', 'tainacan')), React.createElement(Button, {
      isPrimary: true,
      type: "submit",
      onClick: function onClick() {
        return openItemsModal();
      }
    }, __('Add more items', 'tainacan'))) : null) : null, !selectedItemsHTML.length ? React.createElement(Placeholder, {
    ...
    }, __('Select items', 'tainacan'))) : null, React.createElement("ul", {
      style: {
        gridTemplateColumns: layout == 'grid' ? 'repeat(auto-fill, ' + (gridMargin + (showName ? 220 : 185)) + 'px)' : 'inherit'
      },
...
/***/ "./src/views/gutenberg-blocks/tainacan-items/items-list/items-modal.js":
/*!*****************************************************************************!*\
  !*** ./src/views/gutenberg-blocks/tainacan-items/items-list/items-modal.js ***!
  \*****************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return ItemsModal; });
...
function (_React$Component) {
  _inherits(ItemsModal, _React$Component);

  function ItemsModal(props) {
    var _this;

    _classCallCheck(this, ItemsModal);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(ItemsModal).call(this, props)); // Initialize state
    ...
    _this.fetchItems = _this.fetchItems.bind(_assertThisInitialized(_assertThisInitialized(_this)));
  ...
  _createClass(ItemsModal, [{
    ...
    key: "fetchItems",
    value: function fetchItems(selectedItems) {
      var _this2 = this;
      ...
      _js_axios_js__WEBPACK_IMPORTED_MODULE_0__["default"].get(endpoint, {
        ...
        var someItems = response.data.items.map(function (item) {
          return {
            title: item.title,
            id: isNaN(item.id) ? item.id : 'item-id-' + item.id,
            url: item.url,
        ...
        _this2.props.onApplySelection(someItems);
    ...
    value: function fetchModalCollections() {
      ...
      _js_axios_js__WEBPACK_IMPORTED_MODULE_0__["default"].get(endpoint).then(function (response) {
        var otherModalCollections = _this3.state.modalCollections;
    ...
    value: function fetchCollection(collectionId) {
      ...
      _js_axios_js__WEBPACK_IMPORTED_MODULE_0__["default"].get('/collections/' + collectionId).then(function (response) {
        _this4.setState({
    ...
    value: function render() {
      ...
      React.createElement(Modal, {
        ...
        isPrimary: true,
        onClick: function onClick() {
          return _this6.applySelectedItems();
        }
      }, __('Add the selected items', 'tainacan')))) : // Collections modal
      React.createElement(Modal, {
        ...
        onChange: function onChange(value) {
          ...
          _.debounce(_this6.fetchCollections(value), 300);
        }
        ...
        onChange: function onChange(aCollectionOrderBy) {
          _this6.state.collectionOrderBy = aCollectionOrderBy;
          _this6.state.collectionPage = 1;

          _this6.setState({
            collectionOrderBy: _this6.state.collectionOrderBy,
            collectionPage: _this6.state.collectionPage
          });

          if (_this6.state.searchCollectionName && _this6.state.searchCollectionName != '') {
            _this6.fetchCollections(_this6.state.searchCollectionName);
          } else {
            _this6.fetchModalCollections();
          }
        }
        ...
        isSmall: true,
        onClick: function onClick() {
          return _this6.fetchModalCollections();
        }
        ...
        onClick: function onClick() {
          return _this6.selectCollection(_this6.state.temporaryCollectionId);
        }
      }, __('Select items', 'tainacan')), this.state.isLoadingItems ? React.createElement(Spinner, null) : null)));
    }
  }]);
