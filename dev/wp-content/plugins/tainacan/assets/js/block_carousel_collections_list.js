...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/views/gutenberg-blocks/tainacan-collections/carousel-collections-list/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/views/gutenberg-blocks/tainacan-collections/carousel-collections-list/carousel-collections-modal.js":
/*!*****************************************************************************************************************!*\
  !*** ./src/views/gutenberg-blocks/tainacan-collections/carousel-collections-list/carousel-collections-modal.js ***!
  \*****************************************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CollectionsModal; });
...
var CollectionsModal =
/*#__PURE__*/
function (_React$Component) {
  _inherits(CollectionsModal, _React$Component);

  function CollectionsModal(props) {
    var _this;

    _classCallCheck(this, CollectionsModal);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(CollectionsModal).call(this, props)); // Initialize state
    ...
    _this.selectTemporaryCollection = _this.selectTemporaryCollection.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.removeTemporaryCollectionOfId = _this.removeTemporaryCollectionOfId.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.applySelectedCollections = _this.applySelectedCollections.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.isTemporaryCollectionSelected = _this.isTemporaryCollectionSelected.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.toggleSelectTemporaryCollection = _this.toggleSelectTemporaryCollection.bind(_assertThisInitialized(_assertThisInitialized(_this)));
    _this.cancelSelection = _this.cancelSelection.bind(_assertThisInitialized(_assertThisInitialized(_this)));
  ...
  _createClass(CollectionsModal, [{
    ...
    key: "selectTemporaryCollection",
    value: function selectTemporaryCollection(collection) {
      var existingCollectionIndex = this.state.temporarySelectedCollections.findIndex(function (existingCollection) {
        return existingCollection.id == collection.id;
      });

      if (existingCollectionIndex < 0) {
        var aTemporarySelectedCollections = this.state.temporarySelectedCollections;
        ...
        this.setState({
          temporarySelectedCollections: aTemporarySelectedCollections
        });
      }
    }
  }, {
    key: "removeTemporaryCollectionOfId",
    value: function removeTemporaryCollectionOfId(collectionId) {
      var existingCollectionIndex = this.state.temporarySelectedCollections.findIndex(function (existingCollection) {
        return existingCollection.id == collectionId;
      });
    ...
    key: "applySelectedCollections",
    value: function applySelectedCollections() {
      var aSelectedCollectionsObject = JSON.parse(JSON.stringify(this.state.temporarySelectedCollections));
      this.props.onApplySelection(aSelectedCollectionsObject);
    }
  }, {
    key: "isTemporaryCollectionSelected",
    value: function isTemporaryCollectionSelected(collectionId) {
      return this.state.temporarySelectedCollections.findIndex(function (collection) {
        return collection.id == collectionId;
      }) >= 0;
    }
  }, {
    key: "toggleSelectTemporaryCollection",
    value: function toggleSelectTemporaryCollection(collection, isChecked) {
      if (isChecked) this.selectTemporaryCollection(collection);else this.removeTemporaryCollectionOfId(collection.id);
    }
  }, {
    key: "cancelSelection",
    ...
    value: function fetchModalCollections() {
      ...
      var currentModalCollections = this.state.modalCollections;
      if (this.state.collectionsPage <= 1) currentModalCollections = [];
      var endpoint = '/collections/?orderby=title&order=asc&perpage=' + this.state.collectionsPerPage + '&paged=' + this.state.collectionsPage;
      this.setState({
      ...
      _js_axios_js__WEBPACK_IMPORTED_MODULE_0__["default"].get(endpoint).then(function (response) {
        ...
        _this2.setState({
          collectionsPage: _this2.state.collectionsPage + 1,
          isLoadingCollections: false,
          modalCollections: currentModalCollections,
    ...
    value: function fetchCollections(name) {
      ...
      var endpoint = '/collections/?orderby=title&order=asc&perpage=' + this.state.collectionsPerPage;
      ...
      _js_axios_js__WEBPACK_IMPORTED_MODULE_0__["default"].get(endpoint, {
        ...
        var someCollections = _this3.state.collections;
        someCollections = response.data.map(function (collection) {
          return {
            name: collection.name,
            id: collection.id,
            url: collection.url,
    ...
    value: function render() {
      ...
      return React.createElement(Modal, {
        ...
        onChange: function onChange(value) {
          return _this4.fetchCollections(value);
        }
      })), this.state.searchCollectionName != '' ? this.state.collections.length > 0 ? React.createElement("div", null, React.createElement("ul", {
        ...
        return React.createElement("li", {
          ...
          "aria-hidden": true,
          src: collection.thumbnail && collection.thumbnail[0] && collection.thumbnail[0].src ? collection.thumbnail[0].src : "".concat(tainacan_blocks.base_url, "/assets/images/placeholder_square.png"),
          ...
          checked: _this4.isTemporaryCollectionSelected(collection.id),
          onChange: function onChange(isChecked) {
            _this4.toggleSelectTemporaryCollection(collection, isChecked);
          }
        }));
      })), this.state.isLoadingCollections ? React.createElement("div", {
        class: "spinner-container"
      }, React.createElement(Spinner, null)) : null) : this.state.isLoadingCollections ? React.createElement("div", {
        class: "spinner-container"
      }, React.createElement(Spinner, null)) : React.createElement("div", {
        className: "modal-loadmore-section"
      }, React.createElement("p", null, __('Sorry, no collections found.', 'tainacan'))) : this.state.modalCollections.length > 0 ? React.createElement("div", null, React.createElement("ul", {
        className: "modal-checkbox-list"
      }, this.state.modalCollections.map(function (collection) {
        return React.createElement("li", {
          key: collection.id,
          className: "modal-checkbox-list-item"
        }, collection.thumbnail ? React.createElement("img", {
        ...
        onClick: function onClick() {
          return _this4.fetchModalCollections();
        }
      }, __('Load more', 'tainacan')) : null)) : this.state.isLoadingCollections ? React.createElement(Spinner, null) : React.createElement("div", {
        className: "modal-loadmore-section"
      }, React.createElement("p", null, __('Sorry, no collections found.', 'tainacan'))), React.createElement("div", {
        ...
        type: "submit",
        onClick: function onClick() {
          return _this4.applySelectedCollections();
        }
      }, __('Finish', 'tainacan')))));
    }
  }]);
...
/***/ "./src/views/gutenberg-blocks/tainacan-collections/carousel-collections-list/index.js":
/*!********************************************************************************************!*\
  !*** ./src/views/gutenberg-blocks/tainacan-collections/carousel-collections-list/index.js ***!
  \********************************************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _carousel_collections_modal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./carousel-collections-modal.js */ "./src/views/gutenberg-blocks/tainacan-collections/carousel-collections-list/carousel-collections-modal.js");
...
registerBlockType('tainacan/carousel-collections-list', {
  ...
  edit: function edit(_ref) {
    ...
    var collections = attributes.collections,
        ...
        selectedCollections = attributes.selectedCollections,
        ...
        showCollectionThumbnail = attributes.showCollectionThumbnail; // Obtains block's client id to render it on save function
    ...
    function prepareItem(collection, collectionItems) {
      return React.createElement("li", {
        ...
        onClick: function onClick() {
          return removeItemOfId(collection.id);
        },
        icon: "no-alt",
        ...
        src: collectionItems[0] && collectionItems[0].thumbnail && collectionItems[0].thumbnail['tainacan-medium'][0] && collectionItems[0].thumbnail['tainacan-medium'][0] ? collectionItems[0].thumbnail['tainacan-medium'][0] : collectionItems[0] && collectionItems[0].thumbnail && collectionItems[0].thumbnail['thumbnail'][0] && collectionItems[0].thumbnail['thumbnail'][0] ? collectionItems[0].thumbnail['thumbnail'][0] : "".concat(tainacan_blocks.base_url, "/assets/images/placeholder_square.png"),
        alt: collectionItems[0] && collectionItems[0].name ? collectionItems[0].name : __('Thumbnail', 'tainacan')
      }), React.createElement("img", {
        src: collectionItems[1] && collectionItems[1].thumbnail && collectionItems[1].thumbnail['tainacan-medium'][0] && collectionItems[1].thumbnail['tainacan-medium'][0] ? collectionItems[1].thumbnail['tainacan-medium'][0] : collectionItems[1] && collectionItems[1].thumbnail && collectionItems[1].thumbnail['thumbnail'][0] && collectionItems[1].thumbnail['thumbnail'][0] ? collectionItems[1].thumbnail['thumbnail'][0] : "".concat(tainacan_blocks.base_url, "/assets/images/placeholder_square.png"),
        alt: collectionItems[1] && collectionItems[1].name ? collectionItems[1].name : __('Thumbnail', 'tainacan')
      }), React.createElement("img", {
        src: collectionItems[2] && collectionItems[2].thumbnail && collectionItems[2].thumbnail['tainacan-medium'][0] && collectionItems[2].thumbnail['tainacan-medium'][0] ? collectionItems[2].thumbnail['tainacan-medium'][0] : collectionItems[2] && collectionItems[2].thumbnail && collectionItems[2].thumbnail['thumbnail'][0] && collectionItems[2].thumbnail['thumbnail'][0] ? collectionItems[2].thumbnail['thumbnail'][0] : "".concat(tainacan_blocks.base_url, "/assets/images/placeholder_square.png"),
        alt: collectionItems[2] && collectionItems[2].name ? collectionItems[2].name : __('Thumbnail', 'tainacan')
      })) : React.createElement("img", {
        src: collection.thumbnail && collection.thumbnail['tainacan-medium'][0] && collection.thumbnail['tainacan-medium'][0] ? collection.thumbnail['tainacan-medium'][0] : collection.thumbnail && collection.thumbnail['thumbnail'][0] && collection.thumbnail['thumbnail'][0] ? collection.thumbnail['thumbnail'][0] : "".concat(tainacan_blocks.base_url, "/assets/images/placeholder_square.png"),
    ...
    function setContent() {
      ...
      if (itemsRequestSource != undefined && typeof itemsRequestSource == 'function') itemsRequestSource.cancel('Previous collections search canceled.');
        ...
        if (showCollectionThumbnail) {
          ...
          try {
            var _loop = function _loop() {
              ...
              promises.push(_js_axios_js__WEBPACK_IMPORTED_MODULE_1__["default"].get('/collection/' + collection.id + '/items?perpage=3&fetch_only=name,url,thumbnail').then(function (response) {
                return {
    ...
    function removeItemOfId(itemId) {
      var existingItemIndex = collections.findIndex(function (existingItem) {
        return existingItem.key == itemId;
      });
      if (existingItemIndex >= 0) collections.splice(existingItemIndex, 1);
      var existingSelectedItemIndex = selectedCollections.findIndex(function (existingSelectedItem) {
        return existingSelectedItem == itemId;
      });
      if (existingSelectedItemIndex >= 0) selectedCollections.splice(existingSelectedItemIndex, 1);
      setAttributes({
    ...
    return React.createElement("div", {
      ...
      className: "collection-carousel-view-modes"
    }, React.createElement("button", {
      onClick: function onClick() {
    ...
    }))))), isSelected ? React.createElement("div", null, isModalOpen ? React.createElement(_carousel_collections_modal_js__WEBPACK_IMPORTED_MODULE_0__["default"], {
      selectedCollectionsObject: selectedCollections,
      onApplySelection: function onApplySelection(aSelectionOfCollections) {
        selectedCollections = selectedCollections.concat(aSelectionOfCollections.map(function (collection) {
    ...
    }) : null, collections.length ? React.createElement("div", {
      ...
      d: "M18,17v2H12a5.65,5.65,0,0,0-.36-2ZM2,7v7.57a5.74,5.74,0,0,1,2-1.2V7ZM20,6H15L13,4H8A2,2,0,0,0,6,6v7a6,6,0,0,1,5.19,3H20a2,2,0,0,0,2-2V8A2,2,0,0,0,20,6ZM7,16.05v6.06l3.06-3.06ZM5,22.11V16.05L1.94,19.11Z"
    })), __('List collections on a Carousel', 'tainacan')), React.createElement(Button, {
      isPrimary: true,
      type: "submit",
      onClick: function onClick() {
      ...
      d: "M18,17v2H12a5.65,5.65,0,0,0-.36-2ZM2,7v7.57a5.74,5.74,0,0,1,2-1.2V7ZM20,6H15L13,4H8A2,2,0,0,0,6,6v7a6,6,0,0,1,5.19,3H20a2,2,0,0,0,2-2V8A2,2,0,0,0,20,6ZM7,16.05v6.06l3.06-3.06ZM5,22.11V16.05L1.94,19.11Z"
    })), __('List collections on a Carousel, showing their thumbnails or a preview of items.', 'tainacan')), React.createElement(Button, {
      isPrimary: true,
      type: "submit",
      onClick: function onClick() {
        return openCarouselModal();
      }
    }, __('Select Collections', 'tainacan'))) : null, isLoading ? React.createElement("div", {
      class: "spinner-container"
    }, React.createElement(Spinner, null)) : React.createElement("div", null, isSelected && collections.length ? React.createElement("div", {
      class: "preview-warning"
    }, __('Warning: this is just a demonstration. To see the carousel in action, either preview or publish your post.', 'tainacan')) : null, collections.length ? React.createElement("div", {
      ...
      className: 'collections-list-edit'
    }, collections), React.createElement("button", {
  ...
  save: function save(_ref2) {
    ...
    var content = attributes.content,
        ...
        selectedCollections = attributes.selectedCollections,
        arrowsPosition = attributes.arrowsPosition,
        maxCollectionsNumber = attributes.maxCollectionsNumber,
        autoPlay = attributes.autoPlay,
        autoPlaySpeed = attributes.autoPlaySpeed,
        loopSlides = attributes.loopSlides,
        hideName = attributes.hideName,
        showCollectionThumbnail = attributes.showCollectionThumbnail;
    return React.createElement("div", {
      className: className,
