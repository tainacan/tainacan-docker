...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/views/gutenberg-blocks/tainacan-items/carousel-items-list/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/views/gutenberg-blocks/tainacan-items/carousel-items-list/carousel-items-modal.js":
/*!***********************************************************************************************!*\
  !*** ./src/views/gutenberg-blocks/tainacan-items/carousel-items-list/carousel-items-modal.js ***!
  \***********************************************************************************************/
/*! exports provided: default */
...
/***/ "./src/views/gutenberg-blocks/tainacan-items/carousel-items-list/index.js":
/*!********************************************************************************!*\
  !*** ./src/views/gutenberg-blocks/tainacan-items/carousel-items-list/index.js ***!
  \********************************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _carousel_items_modal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./carousel-items-modal.js */ "./src/views/gutenberg-blocks/tainacan-items/carousel-items-list/carousel-items-modal.js");
  ...
  edit: function edit(_ref) {
    ...
    function prepareItem(item) {
      return React.createElement("li", {
        ...
        src: item.thumbnail && item.thumbnail['tainacan-medium'][0] && item.thumbnail['tainacan-medium'][0] ? item.thumbnail['tainacan-medium'][0] : item.thumbnail && item.thumbnail['thumbnail'][0] && item.thumbnail['thumbnail'][0] ? item.thumbnail['thumbnail'][0] : "".concat(tainacan_blocks.base_url, "/assets/images/placeholder_square.png"),
    ...
    function setContent() {
      ...
      if (loadStrategy == 'selection') {
        ...
        _js_axios_js__WEBPACK_IMPORTED_MODULE_1__["default"].get(_endpoint, {
          cancelToken: itemsRequestSource.token
        }).then(function (response) {
