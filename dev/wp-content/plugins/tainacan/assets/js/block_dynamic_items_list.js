...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/views/gutenberg-blocks/tainacan-items/dynamic-items-list/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/views/gutenberg-blocks/tainacan-items/dynamic-items-list/dynamic-items-modal.js":
/*!*********************************************************************************************!*\
  !*** ./src/views/gutenberg-blocks/tainacan-items/dynamic-items-list/dynamic-items-modal.js ***!
  \*********************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return DynamicItemsModal; });
...
var DynamicItemsModal =
/*#__PURE__*/
function (_React$Component) {
  _inherits(DynamicItemsModal, _React$Component);

  function DynamicItemsModal(props) {
    var _this;

    _classCallCheck(this, DynamicItemsModal);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(DynamicItemsModal).call(this, props)); // Initialize state
  ...
  _createClass(DynamicItemsModal, [{
    ...
    value: function componentWillMount() {
      ...
      if (this.props.existingCollectionId != null && this.props.existingCollectionId != undefined) {
        ...
        this.setState({
          searchURL: this.props.existingSearchURL ? this.props.existingSearchURL : tainacan_blocks.admin_url + 'admin.php?page=tainacan_admin#/collections/' + this.props.existingCollectionId + '/items/?readmode=true&iframemode=true'
        });
      } else {
        this.setState({
          collectionPage: 1
    ...
    value: function fetchModalCollections() {
      ...
      var endpoint = '/collections/?orderby=title&order=asc&perpage=' + this.state.collectionsPerPage + '&paged=' + this.state.collectionPage;
      this.setState({
    ...
    value: function render() {
      ...
      }, __('Use this search', 'tainacan')))) : // Collections modal
      React.createElement(Modal, {
...
/***/ "./src/views/gutenberg-blocks/tainacan-items/dynamic-items-list/index.js":
/*!*******************************************************************************!*\
  !*** ./src/views/gutenberg-blocks/tainacan-items/dynamic-items-list/index.js ***!
  \*******************************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dynamic_items_modal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dynamic-items-modal.js */ "./src/views/gutenberg-blocks/tainacan-items/dynamic-items-list/dynamic-items-modal.js");
  ...
  edit: function edit(_ref) {
    ...
    function prepareItem(item) {
      return React.createElement("li", {
        ...
        style: {
          ...
          backgroundPosition: layout == 'mosaic' ? "".concat((mosaicItemFocalPoint && mosaicItemFocalPoint.x ? mosaicItemFocalPoint.x : 0.5) * 100, "% ").concat((mosaicItemFocalPoint && mosaicItemFocalPoint.y ? mosaicItemFocalPoint.y : 0.5) * 100, "%") : 'none'
        }
    ...
    function fetchCollectionForHeader() {
      if (showCollectionHeader) {
        ...
        _js_axios_js__WEBPACK_IMPORTED_MODULE_1__["default"].get('/collections/' + collectionId + '?fetch_only=name,thumbnail,header_image').then(function (response) {
    ...
    function getItemThumbnail(item, size) {
      return item.thumbnail && item.thumbnail[size][0] && item.thumbnail[size][0] ? item.thumbnail[size][0] : item.thumbnail && item.thumbnail['thumbnail'][0] && item.thumbnail['thumbnail'][0] ? item.thumbnail['thumbnail'][0] : "".concat(tainacan_blocks.base_url, "/assets/images/placeholder_square.png");
    }
    ...
    return React.createElement("div", {
      ...
      min: 1,
      max: 96
    })), React.createElement("hr", null), React.createElement("div", null, layout == 'list' ? React.createElement(ToggleControl, {
      ...
      d: "M14,2V4H7v7.24A5.33,5.33,0,0,0,5.5,11a4.07,4.07,0,0,0-.5,0V4A2,2,0,0,1,7,2Zm7,10v8a2,2,0,0,1-2,2H12l1-1-2.41-2.41A5.56,5.56,0,0,0,11,16.53a5.48,5.48,0,0,0-2-4.24V8a2,2,0,0,1,2-2h4Zm-2.52,0L14,7.5V12ZM11,21l-1,1L8.86,20.89,8,20H8l-.57-.57A3.42,3.42,0,0,1,5.5,20a3.5,3.5,0,0,1-.5-7,2.74,2.74,0,0,1,.5,0,3.41,3.41,0,0,1,1.5.34,3.5,3.5,0,0,1,2,3.16,3.42,3.42,0,0,1-.58,1.92L9,19H9l.85.85Zm-4-4.5A1.5,1.5,0,0,0,5.5,15a1.39,1.39,0,0,0-.5.09A1.5,1.5,0,0,0,5.5,18a1.48,1.48,0,0,0,1.42-1A1.5,1.5,0,0,0,7,16.53Z"
    })), __('Dynamically list items from a Tainacan items search', 'tainacan')), React.createElement(Button, {
      isPrimary: true,
      type: "submit",
      onClick: function onClick() {
        return openDynamicItemsModal();
      }
    }, __('Configure search', 'tainacan'))) : null) : null, showCollectionHeader ? React.createElement("div", null, " ", isLoadingCollection ? React.createElement("div", {
    ...
    }))) : null, showSearchBar ? React.createElement("div", {
      ...
      d: "M6.7,10.8l-3.3,3.3L0,10.8h2.5V0h1.7v10.8H6.7z M11.7,0.8H8.3v1.7h3.3V0.8z M14.2,5.8H8.3v1.7h5.8V5.8z M16.7,10.8H8.3v1.7\th8.3V10.8z"
    }))))), React.createElement(Button, {
      onClick: function onClick() {
        order = 'desc';
        setAttributes({
      ...
      text: __('If necessary, pagination will be available on post or page.', 'tainacan')
    }, React.createElement("button", {
