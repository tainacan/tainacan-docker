...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/views/gutenberg-blocks/tainacan-collections/collections-list/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/views/gutenberg-blocks/tainacan-collections/collections-list/collections-modal.js":
/*!***********************************************************************************************!*\
  !*** ./src/views/gutenberg-blocks/tainacan-collections/collections-list/collections-modal.js ***!
  \***********************************************************************************************/
/*! exports provided: default */
  ...
  _createClass(CollectionsModal, [{
    ...
    value: function selectTemporaryCollection(collection) {
      var existingCollectionIndex = this.state.temporarySelectedCollections.findIndex(function (existingCollection) {
        return existingCollection.id == 'collection-id-' + collection.id || existingCollection.id == collection.id;
      });

      if (existingCollectionIndex < 0) {
        var collectionId = isNaN(collection.id) ? collection.id : 'collection-id-' + collection.id;
    ...
    value: function removeTemporaryCollectionOfId(collectionId) {
      var existingCollectionIndex = this.state.temporarySelectedCollections.findIndex(function (existingCollection) {
        return existingCollection.id == 'collection-id-' + collectionId || existingCollection.id == collectionId;
      });
    ...
    value: function isTemporaryCollectionSelected(collectionId) {
      return this.state.temporarySelectedCollections.findIndex(function (collection) {
        return collection.id == collectionId || collection.id == 'collection-id-' + collectionId;
      }) >= 0;
    }
  }, {
...
/***/ "./src/views/gutenberg-blocks/tainacan-collections/collections-list/index.js":
/*!***********************************************************************************!*\
  !*** ./src/views/gutenberg-blocks/tainacan-collections/collections-list/index.js ***!
  \***********************************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _collections_modal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./collections-modal.js */ "./src/views/gutenberg-blocks/tainacan-collections/collections-list/collections-modal.js");
...
registerBlockType('tainacan/collections-list', {
  ...
  icon: React.createElement("svg", {
    ...
    fill: "#298596",
    d: "M10,8.8v1.3H1.2C0.6,10.1,0,9.5,0,8.8V2.5h1.3v6.3H10z M6.9,0H3.8C3.1,0,2.5,0.6,2.5,1.3l0,5c0,0.7,0.6,1.2,1.3,1.2h7.5 c0.7,0,1.3-0.6,1.3-1.2V2.5c0-0.7-0.6-1.2-1.3-1.2H8.2L6.9,0z"
  })),
  ...
  edit: function edit(_ref) {
    ...
    var selectedCollectionsObject = attributes.selectedCollectionsObject,
        selectedCollectionsHTML = attributes.selectedCollectionsHTML,
    ...
    function prepareCollection(collection) {
      return React.createElement("li", {
        ...
        onClick: function onClick() {
          return removeCollectionOfId(collection.id);
        },
        icon: "no-alt",
    ...
    function setContent() {
      ...
      for (var i = 0; i < selectedCollectionsObject.length; i++) {
    ...
    function removeCollectionOfId(collectionId) {
      var existingCollectionIndex = selectedCollectionsObject.findIndex(function (existingCollection) {
        return existingCollection.id == 'collection-id-' + collectionId || existingCollection.id == collectionId;
      });
      if (existingCollectionIndex >= 0) selectedCollectionsObject.splice(existingCollectionIndex, 1);
      setContent();
    }
    ...
    return React.createElement("div", {
    ...
    }, layout == 'list' ? React.createElement(ToggleControl, {
      ...
      min: 0,
      max: 48
    }))) : null))), isSelected ? React.createElement("div", null, isModalOpen ? React.createElement(_collections_modal_js__WEBPACK_IMPORTED_MODULE_0__["default"], {
      selectedCollectionsObject: selectedCollectionsObject,
      onApplySelection: function onApplySelection(aSelectedCollectionsObject) {
    ...
    }) : null, selectedCollectionsHTML.length ? React.createElement("div", {
      ...
      d: "M10,8.8v1.3H1.2C0.6,10.1,0,9.5,0,8.8V2.5h1.3v6.3H10z M6.9,0H3.8C3.1,0,2.5,0.6,2.5,1.3l0,5c0,0.7,0.6,1.2,1.3,1.2h7.5 c0.7,0,1.3-0.6,1.3-1.2V2.5c0-0.7-0.6-1.2-1.3-1.2H8.2L6.9,0z"
    })), __('Expose collections from your Tainacan repository', 'tainacan')), React.createElement(Button, {
      isPrimary: true,
      type: "submit",
      onClick: function onClick() {
        return openCollectionsModal();
      }
    ...
    }, __('Select collections', 'tainacan'))) : null, React.createElement("ul", {
      style: {
        gridTemplateColumns: layout == 'grid' ? 'repeat(auto-fill, ' + (gridMargin + (showName ? 220 : 185)) + 'px)' : 'inherit'
      },
