...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/views/gutenberg-blocks/tainacan-items/search-bar/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/views/gutenberg-blocks/tainacan-items/search-bar/index.js":
/*!***********************************************************************!*\
  !*** ./src/views/gutenberg-blocks/tainacan-items/search-bar/index.js ***!
  \***********************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _search_bar_modal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./search-bar-modal.js */ "./src/views/gutenberg-blocks/tainacan-items/search-bar/search-bar-modal.js");
...
registerBlockType('tainacan/search-bar', {
  ...
  edit: function edit(_ref) {
    ...
    var content = attributes.content,
        ...
        collectionHeaderHeight = attributes.collectionHeaderHeight,
        collectionTextSize = attributes.collectionTextSize,
        ...
        collectionHeaderImage = attributes.collectionHeaderImage,
        collectionName = attributes.collectionName;

    function setContent() {
      setAttributes({
        content: showCollectionHeader ? React.createElement("div", null, collectionHeaderImage ? React.createElement("div", {
          ...
          className: (showCollectionHeader ? 'search-bar-collection-header-container' : '') + (alignment == 'left' ? ' is-aligned-left' : '') + (alignment == 'right' ? ' is-aligned-right' : ''),
          style: {
          ...
          class: "label"
        }, __('Collection', 'tainacan')) : null, React.createElement("h3", {
          style: {
            fontSize: collectionTextSize ? collectionTextSize + 'rem' : '2rem'
          }
        }, collectionName ? collectionName : '')), collectionId && collectionSlug ? React.createElement("div", {
          class: "tainacan-search-container"
          ...
          style: {
            fill: showCollectionHeader && collectionBackgroundColor ? collectionBackgroundColor : ''
          },
          width: "24",
          height: "24",
          viewBox: "-2 -3 20 20"
    ...
    return React.createElement("div", {
    ...
    }))), React.createElement("div", null, React.createElement(InspectorControls, null, React.createElement("hr", null), React.createElement("div", {
      style: {
        marginTop: '24px'
      }
      ...
      onChange: function onChange(aPlaceholderText) {
      ...
      onChange: function onChange(aMaxWidth) {
        maxWidth = aMaxWidth;
        setAttributes({
          maxWidth: aMaxWidth
        });
      ...
      min: 15,
      max: 100
    })), React.createElement("br", null), React.createElement(PanelBody, {
      ...
      options: [{
        label: __('Large', 'tainacan'),
        value: 2.5
      }, {
        label: __('Medium', 'tainacan'),
        value: 2
      }, {
        label: __('Small', 'tainacan'),
        value: 1.5
      }],
      onChange: function onChange(size) {
        collectionTextSize = size;
        setAttributes({
          collectionTextSize: collectionTextSize
        });
      }
    })) : null))), isSelected ? React.createElement("div", null, isModalOpen ? React.createElement(_search_bar_modal_js__WEBPACK_IMPORTED_MODULE_0__["default"], {
    ...
    }) : null, collectionId ? React.createElement("div", {
      ...
      d: "M0,5.8C0,5,0.2,4.2,0.5,3.5s0.7-1.3,1.2-1.8s1.1-0.9,1.8-1.2C4.2,0.1,5,0,5.8,0S7.3,0.1,8,0.5 c0.7,0.3,1.3,0.7,1.8,1.2s0.9,1.1,1.2,1.8c0.5,1.2,0.5,2.5,0.2,3.7c0,0.2-0.1,0.4-0.2,0.6c0,0.1-0.2,0.6-0.2,0.6 c0.6,0.6,1.3,1.3,1.9,1.9c0.7,0.7,1.3,1.3,2,2c0,0,0.3,0.2,0.3,0.3c0,0.3-0.1,0.7-0.3,1c-0.2,0.6-0.8,1-1.4,1.2 c-0.1,0-0.6,0.2-0.6,0.1c0,0-4.2-4.2-4.2-4.2c0,0-0.8,0.3-0.8,0.4c-1.3,0.4-2.8,0.5-4.1-0.1c-0.7-0.3-1.3-0.7-1.8-1.2 C1.2,9.3,0.8,8.7,0.5,8S0,6.6,0,5.8z M1.6,5.8c0,0.4,0.1,0.9,0.2,1.3C2.1,8.2,3,9.2,4.1,9.6c0.5,0.2,1,0.3,1.6,0.3 c0.6,0,1.1-0.1,1.6-0.3C8.7,9,9.7,7.6,9.8,6c0.1-1.5-0.6-3.1-2-3.9c-0.9-0.5-2-0.6-3-0.4C4.6,1.8,4.4,1.9,4.1,2 c-0.5,0.2-1,0.5-1.4,0.9C2,3.7,1.6,4.7,1.6,5.8z"
    })))), __('Set up a custom search bar to redirect to an item\'s list', 'tainacan')), React.createElement(Button, {
      isPrimary: true,
      type: "submit",
      onClick: function onClick() {
        return openSearchBarModal();
      }
    ...
    }, __('Select search source', 'tainacan'))) : null, showCollectionHeader ? React.createElement("div", null, collectionHeaderImage ? React.createElement("div", {
      className: 'search-bar-collection-header-image',
      style: {
        backgroundImage: 'url(' + collectionHeaderImage + ')',
        height: collectionHeaderHeight ? collectionHeaderHeight + 'px' : '160px'
      ...
      d: "M0,5.8C0,5,0.2,4.2,0.5,3.5s0.7-1.3,1.2-1.8s1.1-0.9,1.8-1.2C4.2,0.1,5,0,5.8,0S7.3,0.1,8,0.5 c0.7,0.3,1.3,0.7,1.8,1.2s0.9,1.1,1.2,1.8c0.5,1.2,0.5,2.5,0.2,3.7c0,0.2-0.1,0.4-0.2,0.6c0,0.1-0.2,0.6-0.2,0.6 c0.6,0.6,1.3,1.3,1.9,1.9c0.7,0.7,1.3,1.3,2,2c0,0,0.3,0.2,0.3,0.3c0,0.3-0.1,0.7-0.3,1c-0.2,0.6-0.8,1-1.4,1.2 c-0.1,0-0.6,0.2-0.6,0.1c0,0-4.2-4.2-4.2-4.2c0,0-0.8,0.3-0.8,0.4c-1.3,0.4-2.8,0.5-4.1-0.1c-0.7-0.3-1.3-0.7-1.8-1.2 C1.2,9.3,0.8,8.7,0.5,8S0,6.6,0,5.8z M1.6,5.8c0,0.4,0.1,0.9,0.2,1.3C2.1,8.2,3,9.2,4.1,9.6c0.5,0.2,1,0.3,1.6,0.3 c0.6,0,1.1-0.1,1.6-0.3C8.7,9,9.7,7.6,9.8,6c0.1-1.5-0.6-3.1-2-3.9c-0.9-0.5-2-0.6-3-0.4C4.6,1.8,4.4,1.9,4.1,2 c-0.5,0.2-1,0.5-1.4,0.9C2,3.7,1.6,4.7,1.6,5.8z"
    }))))))) : null)) : null, collectionId && collectionSlug && !showCollectionHeader ? React.createElement("div", {
      class: "tainacan-search-container"
    }, React.createElement("div", {
      style: {
        maxWidth: maxWidth ? maxWidth + '%' : '80%'
...
/***/ "./src/views/gutenberg-blocks/tainacan-items/search-bar/search-bar-modal.js":
/*!**********************************************************************************!*\
  !*** ./src/views/gutenberg-blocks/tainacan-items/search-bar/search-bar-modal.js ***!
  \**********************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return SearchBarModal; });
...
function (_React$Component) {
  _inherits(SearchBarModal, _React$Component);

  function SearchBarModal(props) {
    var _this;

    _classCallCheck(this, SearchBarModal);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(SearchBarModal).call(this, props)); // Initialize state
  ...
  _createClass(SearchBarModal, [{
    ...
    value: function render() {
      ...
      return React.createElement(Modal, {
        ...
        onClick: function onClick() {
          _this4.selectCollection(_this4.state.temporaryCollectionId);
        }
