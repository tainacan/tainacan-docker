...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/views/gutenberg-blocks/tainacan-facets/faceted-search/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/views/gutenberg-blocks/tainacan-facets/faceted-search/collection-modal.js":
/*!***************************************************************************************!*\
  !*** ./src/views/gutenberg-blocks/tainacan-facets/faceted-search/collection-modal.js ***!
  \***************************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return CollectionModal; });
...
function (_React$Component) {
  _inherits(CollectionModal, _React$Component);

  function CollectionModal(props) {
    var _this;

    _classCallCheck(this, CollectionModal);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(CollectionModal).call(this, props)); // Initialize state
    ...
    value: function render() {
      ...
      return React.createElement(Modal, {
        ...
        onChange: function onChange(value) {
          ...
          _.debounce(_this4.fetchCollections(value), 300);
        }
        ...
        onChange: function onChange(aCollectionOrderBy) {
          _this4.state.collectionOrderBy = aCollectionOrderBy;
          _this4.state.collectionPage = 1;

          _this4.setState({
            collectionOrderBy: _this4.state.collectionOrderBy,
            collectionPage: _this4.state.collectionPage
          });

          if (_this4.state.searchCollectionName && _this4.state.searchCollectionName != '') {
            _this4.fetchCollections(_this4.state.searchCollectionName);
          } else {
            _this4.fetchModalCollections();
          }
        }
      ...
      }, __('Load more', 'tainacan')) : null)) : this.state.isLoadingCollections ? React.createElement("div", {
        ...
        onClick: function onClick() {
          return _this4.selectCollection(_this4.state.temporaryCollectionId);
        }
      }, __('Use selected Collection', 'tainacan')), this.state.isLoadingItems ? React.createElement(Spinner, null) : null)));
    }
  }]);
...
/***/ "./src/views/gutenberg-blocks/tainacan-facets/faceted-search/index.js":
/*!****************************************************************************!*\
  !*** ./src/views/gutenberg-blocks/tainacan-facets/faceted-search/index.js ***!
  \****************************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _collection_modal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./collection-modal.js */ "./src/views/gutenberg-blocks/tainacan-facets/faceted-search/collection-modal.js");
/* harmony import */ var _term_modal_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./term-modal.js */ "./src/views/gutenberg-blocks/tainacan-facets/faceted-search/term-modal.js");
...
registerBlockType('tainacan/faceted-search', {
  ...
  edit: function edit(_ref) {
    ...
    var termId = attributes.termId,
        ...
        defaultViewMode = attributes.defaultViewMode,
        enabledViewModes = attributes.enabledViewModes,
        hideFilters = attributes.hideFilters,
        hideHideFiltersButton = attributes.hideHideFiltersButton,
        hideSearch = attributes.hideSearch,
        hideAdvancedSearch = attributes.hideAdvancedSearch,
        hideSortByButton = attributes.hideSortByButton,
        hideItemsPerPageButton = attributes.hideItemsPerPageButton,
        hideGoToPageButton = attributes.hideGoToPageButton,
        startWithFiltersHidden = attributes.startWithFiltersHidden,
        filtersAsModal = attributes.filtersAsModal,
        ...
        isCollectionModalOpen = attributes.isCollectionModalOpen,
        isTermModalOpen = attributes.isTermModalOpen;
    ...
    return React.createElement("div", {
    ...
    })))), isSelected ? React.createElement("div", null, React.createElement("div", {
      ...
      fill: "#298596",
      d: "M21.43,13.64,19.32,16a2.57,2.57,0,0,1-2,1H11a3.91,3.91,0,0,0,0-.49,5.49,5.49,0,0,0-5-5.47V9.64A2.59,2.59,0,0,1,8.59,7H17.3a2.57,2.57,0,0,1,2,1l2.11,2.38A2.59,2.59,0,0,1,21.43,13.64ZM4,3A2,2,0,0,0,2,5v7.3a5.32,5.32,0,0,1,2-1V5H16V3ZM11,21l-1,1L8.86,20.89,8,20H8l-.57-.57A3.42,3.42,0,0,1,5.5,20a3.5,3.5,0,0,1,0-7,2.74,2.74,0,0,1,.5,0A3.5,3.5,0,0,1,9,16a2.92,2.92,0,0,1,0,.51,3.42,3.42,0,0,1-.58,1.92L9,19H9l.85.85Zm-4-4.5A1.5,1.5,0,1,0,5.5,18,1.5,1.5,0,0,0,7,16.53Z"
    })), __('Show items list from: ', 'tainacan'), "\xA0", React.createElement(SelectControl, {
      ...
      onChange: function onChange(aListType) {
        listType = aListType;
        setAttributes({
          listType: aListType
        });
      }
    }), "\xA0", listType == 'collection' && collectionId != undefined || listType == 'term' && termId != undefined ? React.createElement(Button, {
      isPrimary: true,
      type: "submit",
      onClick: function onClick() {
        return listType == 'term' ? openTermModal() : openCollectionModal();
      }
    }, listType == 'term' ? __('Change Term', 'tainacan') : __('Change Collection', 'tainacan')) : null))) : null, termId == undefined && listType == 'term' || collectionId == undefined && listType == 'collection' ? React.createElement(Placeholder, {
      ...
      fill: "#298596",
      d: "M21.43,13.64,19.32,16a2.57,2.57,0,0,1-2,1H11a3.91,3.91,0,0,0,0-.49,5.49,5.49,0,0,0-5-5.47V9.64A2.59,2.59,0,0,1,8.59,7H17.3a2.57,2.57,0,0,1,2,1l2.11,2.38A2.59,2.59,0,0,1,21.43,13.64ZM4,3A2,2,0,0,0,2,5v7.3a5.32,5.32,0,0,1,2-1V5H16V3ZM11,21l-1,1L8.86,20.89,8,20H8l-.57-.57A3.42,3.42,0,0,1,5.5,20a3.5,3.5,0,0,1,0-7,2.74,2.74,0,0,1,.5,0A3.5,3.5,0,0,1,9,16a2.92,2.92,0,0,1,0,.51,3.42,3.42,0,0,1-.58,1.92L9,19H9l.85.85Zm-4-4.5A1.5,1.5,0,1,0,5.5,18,1.5,1.5,0,0,0,7,16.53Z"
    })), __('Show a complete items list with faceted search.', 'tainacan')), React.createElement(Button, {
      isPrimary: true,
      type: "submit",
      onClick: function onClick() {
        return listType == 'term' ? openTermModal() : openCollectionModal();
      }
    }, listType == 'term' ? __('Select a Term', 'tainacan') : __('Select a Collection', 'tainacan'))) : React.createElement("div", null, React.createElement("div", {
      class: "preview-warning"
    }, __('Warning: this is just a demonstration. To see the items list, either preview or publish your post.', 'tainacan')), React.createElement("div", {
    ...
    }) : null, isTermModalOpen ? React.createElement(_term_modal_js__WEBPACK_IMPORTED_MODULE_1__["default"], {
      existingTermId: termId,
      existingTaxonomyId: taxonomyId,
      onSelectTaxonomy: function onSelectTaxonomy(selectedTaxonomy) {
        taxonomyId = selectedTaxonomy;
        setAttributes({
          taxonomyId: selectedTaxonomy
        });
      },
      onSelectTerm: function onSelectTerm(selectedTermId) {
...
/***/ "./src/views/gutenberg-blocks/tainacan-facets/faceted-search/term-modal.js":
/*!*********************************************************************************!*\
  !*** ./src/views/gutenberg-blocks/tainacan-facets/faceted-search/term-modal.js ***!
  \*********************************************************************************/
/*! exports provided: default */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return TermModal; });
/* harmony import */ var _js_axios_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ../../js/axios.js */ "./src/views/gutenberg-blocks/js/axios.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
/*#__PURE__*/
function (_React$Component) {
  _inherits(TermModal, _React$Component);

  function TermModal(props) {
    var _this;

    _classCallCheck(this, TermModal);

    _this = _possibleConstructorReturn(this, _getPrototypeOf(TermModal).call(this, props)); // Initialize state
    ...
    _this.onSelectTerm = _this.onSelectTerm.bind(_assertThisInitialized(_assertThisInitialized(_this)));
  ...
  _createClass(TermModal, [{
    ...
    value: function selectTemporaryTerm(termId) {
      this.setState({
        temporarySelectedTermId: termId
      });
    }
  }, {
    key: "onSelectTerm",
    value: function onSelectTerm() {
    ...
    value: function render() {
      ...
      React.createElement(Modal, {
        ...
        options: this.state.terms.map(function (term) {
          return {
            label: term.name,
            value: '' + term.id
          };
        }),
        onChange: function onChange(aTermId) {
          _this7.selectTemporaryTerm(aTermId);
        }
        ...
        selected: this.state.temporarySelectedTermId,
        options: this.state.modalTerms.map(function (term) {
          return {
            label: term.name,
            value: '' + term.id
          };
