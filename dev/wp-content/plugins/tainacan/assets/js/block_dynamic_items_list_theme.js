...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    ...
    fetchItems: function fetchItems() {
      ...
      if (this.paged != undefined) queryObject.paged = this.paged;else if (queryObject.paged != undefined) this.paged = queryObject.paged;else this.paged = 1; // emove unecessary queries
