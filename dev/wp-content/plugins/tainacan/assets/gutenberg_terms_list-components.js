...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/gutenberg-blocks/tainacan-terms/terms-list/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/gutenberg-blocks/tainacan-terms/terms-list/index.js":
/*!*****************************************************************!*\
  !*** ./src/gutenberg-blocks/tainacan-terms/terms-list/index.js ***!
  \*****************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _terms_modal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./terms-modal.js */ "./src/gutenberg-blocks/tainacan-terms/terms-list/terms-modal.js");
...
registerBlockType('tainacan/terms-list', {
  ...
  edit: function edit(_ref) {
    ...
    var selectedTermsObject = attributes.selectedTermsObject,
        selectedTermsHTML = attributes.selectedTermsHTML,
    ...
    function removeTermOfId(termId) {
      var existingTermIndex = selectedTermsObject.findIndex(function (existingTerm) {
        return existingTerm.id == 'term-id-' + termId || existingTerm.id == termId;
      });
      if (existingTermIndex >= 0) selectedTermsObject.splice(existingTermIndex, 1);
      setContent();
    }
    ...
    return React.createElement("div", {
    ...
    }) : null, layout == 'grid' ? React.createElement(ToggleControl, {
    ...
    }) : null))), isSelected ? React.createElement("div", null, isModalOpen ? React.createElement(_terms_modal_js__WEBPACK_IMPORTED_MODULE_0__["default"], {
      replaceTermId: true,
      ...
      onApplySelection: function onApplySelection(aSelectedTermsObject) {
    ...
    }) : null, selectedTermsHTML.length ? React.createElement("div", {
      ...
      d: "M 4.4,2.5 H 0 V 0 h 4.4 l 1.2,1.3 z m -1.9,5 v 3.1 H 5 v 1.2 H 1.3 v -8 H 2.5 V 6.3 H 5 V 7.6 H 2.5 Z m 8.2,0.7 H 6.3 V 5.7 h 4.4 l 1.2,1.2 z M 11.9,11.3 10.7,10 H 6.3 v 2.5 h 4.4 z"
    })), __('Expose terms from your Tainacan taxonomies', 'tainacan')), React.createElement(Button, {
      isPrimary: true,
      type: "submit",
      onClick: function onClick() {
    ...
    }, __('Select terms', 'tainacan'))) : null, React.createElement("ul", {
      className: 'terms-list-edit terms-layout-' + layout
    }, selectedTermsHTML));
  },
