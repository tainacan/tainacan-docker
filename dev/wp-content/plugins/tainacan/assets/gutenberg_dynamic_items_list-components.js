...
/******/ 	return __webpack_require__(__webpack_require__.s = "./src/gutenberg-blocks/tainacan-items/dynamic-items-list/index.js");
/******/ })
/************************************************************************/
/******/ ({
...
/***/ "./src/gutenberg-blocks/tainacan-items/dynamic-items-list/dynamic-items-modal.js":
/*!***************************************************************************************!*\
  !*** ./src/gutenberg-blocks/tainacan-items/dynamic-items-list/dynamic-items-modal.js ***!
  \***************************************************************************************/
/*! exports provided: default */
...
/***/ "./src/gutenberg-blocks/tainacan-items/dynamic-items-list/index.js":
/*!*************************************************************************!*\
  !*** ./src/gutenberg-blocks/tainacan-items/dynamic-items-list/index.js ***!
  \*************************************************************************/
/*! no exports provided */
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _dynamic_items_modal_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./dynamic-items-modal.js */ "./src/gutenberg-blocks/tainacan-items/dynamic-items-list/dynamic-items-modal.js");
...
registerBlockType('tainacan/dynamic-items-list', {
  ...
  edit: function edit(_ref) {
    ...
    function getItemThumbnail(item, size) {
      return item.thumbnail && item.thumbnail[size][0] && item.thumbnail[size][0] ? item.thumbnail[size][0] : item.thumbnail && item.thumbnail['thumbnail'][0] && item.thumbnail['thumbnail'][0] ? item.thumbnail['thumbnail'][0] : "".concat(tainacan_blocks.base_url, "/admin/images/placeholder_square.png");
    }
