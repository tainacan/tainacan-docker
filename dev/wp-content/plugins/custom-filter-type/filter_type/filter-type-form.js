...
const TainacanFilterFormCustomType = {
	name: "TainacanFilterFormTypeCustom",
	props: {
        ...
        <b-field :addons="false">
            ...
            <div
                ...
                <b-select
                    ...
                    <option
                            v-if="step && 
![0.001,0.01,0.1,1,2,5,10,100,1000].find( function(element) { return element == step } )"
                            :value="step">
                        {{ step }}</option>
                </b-select>
                <button
...
TainacanExtraVueComponents["tainacan-filter-form-type-custom"] = TainacanFilterFormCustomType;
