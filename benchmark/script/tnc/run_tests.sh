...
URL='http://localhost/wp-json/tainacan/v2/collection/5/items?perpage=12&paged=1&order=DESC&orderby=date&admin_view_mode=table&fetch_only=thumbnail&fetch_only_meta=6%2C7%2C8%2C9%2C10%2C11%2C12%2C13%2C14%2C15%2C16%2C17%2C18%2C19%2C20&search=valor-1'
...
do
    ...
    #reindex='{"source": {"index": "'${base_name}'"}, "dest": {"index": "localhost-post-1"}}'
